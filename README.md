Зависимости
Boost 1.58.0
Google Test, Google Mock для тестов.
...
0. Все треды при старте захватывают свой mutex.
